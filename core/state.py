...
class TranscriptState:
    ...
    async def add_line(self, text: str, timestamp: float):
        """
        ...
        print(f"[TranscriptState] Adding line: {text}")
    ...
    def get_transcript_snapshot(self) -> str:
        """
        Returns the full transcript as a formatted string with timestamps.
        """
        formatted_lines = []
